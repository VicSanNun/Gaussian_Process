...
(z, Hz, Sigma) = loadtxt("./outupt_199.txt", unpack='True')
(z_init, Hz_init, Sigma_init) = loadtxt("./inputdata_.txt", unpack='True')

plt.plot(z,Hz)
plt.fill_between(z, Hz-Sigma, Hz+Sigma, facecolor='grey')
